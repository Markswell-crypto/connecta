          ...
          <div className="hidden md:block">
            <div className="ml-10 flex items-baseline space-x-4">
              {currentUser ? (
                ...
                <>
                  <a href="/login" className="px-3 py-2 rounded-md text-sm font-medium text-gray-500 hover:text-gray-900">Login</a>
                  <a href="/register" className="px-3 py-2 rounded-md text-sm font-medium text-gray-500 hover:text-gray-900">Register</a>
                </>
              )}
            </div>
          </div>
